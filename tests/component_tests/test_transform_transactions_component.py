...
- Error handling: Tests behavior with invalid or malformed input
...
def test_transform_transactions_handles_empty_dataframe():
    """Test that clean_transactions raises KeyError for
    empty DataFrame missing required columns."""
...
def test_transform_transactions_handles_empty_rows_with_columns():
    """Test that clean_transactions raises AttributeError for
...
def test_transform_transactions_handles_all_rows_filtered():
    """Test that clean_transactions raises AttributeError when
    processing null datetime values."""
...
def test_transform_transactions_missing_required_column():
    """Test that clean_transactions raises KeyError when
